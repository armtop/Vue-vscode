...
var name = "".concat(prefix, "-popover");
var Popover = vue.defineComponent({
  name: name,
  ...
  setup: function setup(props, context) {
    ...
    var contentClasses = vue.computed(function () {
      return ["".concat(name, "__content"), "".concat(name, "--").concat(props.theme)];
    });
    var popper;
    ...
    var placementPadding = function placementPadding(_ref) {
      ...
      if (isHorizontal) {
        ...
        return _defineProperty__default["default"]({}, isEnd ? "left" : "right", padding - 22);
      }
      var isVertical = vertical.find(function (item) {
        return placement.includes(item);
      });
      if (isVertical) {
        return _defineProperty__default["default"]({}, isEnd ? "top" : "bottom", popperHeight - 22);
      }
    };
...
var _Popover = shared_component.withInstall(Popover);
