...
var script = vue.defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var contentClasses = vue.computed(function () {
      return _defineProperty__default["default"]({}, "".concat(name, "--").concat(props.placement), true);
    });
    ...
    var lock = function lock() {
      if (!lockTimes && shared_util.isBrowser) {
    ...
    var shouldLock = vue.computed(function () {
  ...
  return !_ctx.destroyOnClose || _ctx.wrapperVisible ? (vue.openBlock(), vue.createBlock(vue.Teleport, {
    ...
    default: vue.withCtx(function () {
      return [vue.withDirectives(vue.createElementVNode("div", vue.mergeProps({
        ...
        key: 0,
        class: vue.normalizeClass("".concat(_ctx.name, "__close")),
