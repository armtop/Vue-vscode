...
var footer_props = require('./props.js');
...
var name = "".concat(prefix, "-footer");
var Footer = vue.defineComponent({
  name: name,
  props: footer_props["default"],
  setup: function setup(props) {
    var footerClass = hooks_useClass.usePrefixClass("footer");
    var footerLinkClass = hooks_useClass.usePrefixClass("footer__link");
    var renderLogo = function renderLogo() {
      ...
      return vue.createVNode("a", {
        ...
        "href": logo.url,
        "target": logo.target
      }, [logo.icon && vue.createVNode(image_index["default"], {
...
var _Footer = shared_component.withInstall(Footer);
