...
var _Stepper = vue.defineComponent({
  ...
  setup: function setup(props2, context) {
    var stepperClass = hooks_useClass.usePrefixClass("stepper");
    ...
    var updateValue = function updateValue(value) {
      stepperValue.value = shared_util.formatNumber("".concat(value), !integer.value);
    };
    ...
    var handleInput = function handleInput(e) {
      var value = shared_util.formatNumber(e.target.value, !integer.value);
    ...
    return function () {
      return vue.createVNode("div", {
        ...
        "onClick": minusValue
      }, [vue.createVNode(tdesignIconsVueNext.RemoveIcon, {
        ...
        "onClick": plusValue
      }, [vue.createVNode(tdesignIconsVueNext.AddIcon, {
...
var Stepper = shared_component.withInstall(_Stepper);
