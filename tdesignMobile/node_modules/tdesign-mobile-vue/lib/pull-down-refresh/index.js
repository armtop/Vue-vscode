...
var PullDownRefresh = vue.defineComponent({
  name: name,
  components: {
  ...
  setup: function setup(props) {
    ...
    return function () {
      ...
      var className = "".concat(name, "__track");
      if (status.value !== "pulling") {
        className = "".concat(className, " ").concat(name, "__track--loosing");
      }
      return vue.createVNode("div", {
        "class": name
      }, [vue.createVNode("div", {
        ...
        "ref": maxBar,
        "class": "".concat(name, "__tips"),
        "style": maxBarStyles.value
      }, [vue.createVNode("div", {
        "ref": loadingBar,
        "class": "".concat(name, "__loading"),
...
var _PullDownRefresh = shared_component.withInstall(PullDownRefresh);
