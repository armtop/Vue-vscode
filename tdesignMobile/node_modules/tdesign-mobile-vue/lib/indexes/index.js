...
var indexes_indexesAnchorProps = require('./indexes-anchor-props.js');
...
var name$1 = "".concat(prefix$1, "-indexes");
var LocalIndexes = vue.defineComponent({
  name: name$1,
  ...
  setup: function setup(props) {
    ...
    var handleSidebarTouchmove = function handleSidebarTouchmove(event) {
      ...
      if (target && target.className === "".concat(indexesClass.value, "__sidebar-item") && target instanceof HTMLElement) {
        ...
        var curIndex = /^\d+$/.test(index !== null && index !== void 0 ? index : "") ? Number(index) : index;
...
var name = "".concat(prefix, "-indexes-anchor");
var LocalIndexesAnchor = vue.defineComponent({
  name: name,
  props: indexes_indexesAnchorProps["default"],
  setup: function setup(props) {
    var readerTNodeJSX = hooks_tnode.useTNodeJSX();
    var indexesAnchorClass = hooks_useClass.usePrefixClass("indexes-anchor");
...
var Indexes = shared_component.withInstall(LocalIndexes);
var IndexesAnchor = shared_component.withInstall(LocalIndexesAnchor);
