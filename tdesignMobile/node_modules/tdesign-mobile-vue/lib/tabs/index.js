...
var LocalTabs = vue.defineComponent({
  name: name$1,
  ...
  setup: function setup(props2) {
    ...
    var readerNav = function readerNav() {
      return itemProps.value.map(function (item, index) {
        ...
        }, [vue.createVNode(badge_index["default"], badgeProps, {
    ...
    return function () {
      ...
      }, [vue.createVNode(sticky_index["default"], vue.mergeProps(stickyProps.value, {
...
var LocalTabPanel = vue.defineComponent({
  name: name,
...
var Tabs = shared_component.withInstall(LocalTabs);
var TabPanel = shared_component.withInstall(LocalTabPanel);
