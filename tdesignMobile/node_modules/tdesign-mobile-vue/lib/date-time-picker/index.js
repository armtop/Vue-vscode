...
var _commonjsHelpers = require('../_chunks/dep-2088457f.js');
var customParseFormat = require('../_chunks/dep-a52f931a.js');
...
require('../_chunks/dep-062b4405.js');
...
var DateTimePicker = vue.defineComponent({
  name: name,
  components: {
  ...
  setup: function setup(props) {
    ...
    var _toRefs = vue.toRefs(props),
      value = _toRefs.value;
    var _useVModel = shared_useVModel_index.useVModel(value, vue.ref(props.modelValue), props.defaultValue, props.onChange),
    ...
    var isTimeMode = vue.computed(function () {
      return isArray__default["default"](props.mode) && props.mode[0] == null && ["hour", "minute", "second"].includes(props.mode[1]);
    });
...
var _DateTimePicker = shared_component.withInstall(DateTimePicker);
