...
var Skeleton = vue.defineComponent({
  ...
  setup: function setup(props, _ref2) {
    ...
    var componentName = hooks_useClass.usePrefixClass("skeleton");
    var getColItemClass = function getColItemClass(obj) {
      return ["".concat(componentName.value, "__col"), "".concat(componentName.value, "--type-").concat(obj.type || "text"), _defineProperty__default["default"]({}, "".concat(componentName.value, "--animation-").concat(props.animation), props.animation)];
    };
...
var _Skeleton = shared_component.withInstall(Skeleton);
