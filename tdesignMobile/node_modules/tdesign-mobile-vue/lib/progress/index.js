...
var Progress = vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var componentName = hooks_useClass.usePrefixClass("progress");
    ...
    return function () {
      ...
      var separateClasses = props2.percentage > progress_constants.PLUMP_SEPARATE ? "".concat(componentName.value, "--over-ten") : "".concat(componentName.value, "--under-ten");
      return vue.createVNode("div", {
        ...
        "class": ["".concat(componentName.value, "__bar ").concat(componentName.value, "--plump ").concat(separateClasses), _defineProperty__default["default"]({}, "".concat(componentName.value, "--status-").concat(computedStatus.value), computedStatus.value)],
        "style": trackBgStyle.value
      }, [vue.createVNode("div", {
        "class": "".concat(componentName.value, "__inner"),
        "style": barStyle.value
...
var _Progress = shared_component.withInstall(Progress);
