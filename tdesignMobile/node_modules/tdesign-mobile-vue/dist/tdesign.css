...
.t-button--dashed.t-button--primary {
  color: var(--td-button-primary-dashed-color, var(--td-brand-color, var(--td-brand-color-7, #0052d9)));
}
.t-button--dashed.t-button--primary::after {
  border-color: var(--td-button-primary-dashed-border-color, var(--td-button-primary-dashed-color, var(--td-brand-color, var(--td-brand-color-7, #0052d9))));
}
.t-button--dashed.t-button--primary.t-button--disabled {
  background-color: transparent;
  color: var(--td-button-primary-dashed-disabled-color, var(--td-brand-color-disabled, var(--td-brand-color-3, #b5c7ff)));
}
.t-button--dashed.t-button--primary.t-button--disabled::after {
  border-color: var(--td-button-primary-dashed-disabled-color, var(--td-brand-color-disabled, var(--td-brand-color-3, #b5c7ff)));
}
...
.t-overlay {
  ...
  width: 100%;
  bottom: 0;
  background-color: var(--td-overlay-bg-color, var(--td-text-color-secondary, var(--td-font-gray-2, rgba(0, 0, 0, 0.6))));
  -webkit-transition: opacity var(--td-overlay-transition-duration, 300ms) ease;
...
.t-switch {
  ...
  background-color: var(--td-switch-unchecked-color, var(--td-text-color-disabled, var(--td-font-gray-4, rgba(0, 0, 0, 0.26))));
  position: relative;
...
.t-slider__scale-item--capsule {
  ...
  border-radius: 0;
  background-color: var(--td-slider-capsule-bar-color, var(--td-bg-color-component, var(--td-gray-color-3, #e7e7e7)));
  margin-top: calc(-0.5 * var(--td-slider-capsule-line-heihgt, 18px));
}
...
.t-dialog {
  ...
  border-radius: var(--td-border-radius, var(--td-radius-extra-large, 12px));
  background-color: var(--td-bg-color-container, var(--td-font-white-1, #ffffff));
}
.t-dialog__close-btn {
  position: absolute;
...
.t-dialog__content {
  padding: var(--td-spacer-4, 32px) var(--td-spacer-3, 24px) 0;
...
.t-action-sheet__content {
  ...
  border-top-left-radius: var(--td-action-sheet-border-radius, var(--td-radius-extra-large, 12px));
  border-top-right-radius: var(--td-action-sheet-border-radius, var(--td-radius-extra-large, 12px));
  background-color: var(--td-bg-color-container, var(--td-font-white-1, #ffffff));
  overflow: hidden;
}
...
.t-toast {
  ...
  background-color: var(--td-toast-bg-color, var(--td-font-gray-1, rgba(0, 0, 0, 0.9)));
...
.t-search__label {
  padding: 4px;
  color: var(--search-label-color, var(--td-text-color-primary, var(--td-font-gray-1, rgba(0, 0, 0, 0.9))));
}
.t-search--center {
  text-align: center;
}
...
.t-collapse-panel {
  ...
  overflow: hidden;
  -webkit-transition: height ease 240ms;
...
.t-avatar--medium {
  ...
  font-size: var(--td-avatar-text-medium-font-size, var(--td-font-size-base, 14px));
}
...
.t-avatar--small {
  ...
  font-size: var(--td-avatar-text-small-font-size, var(--td-font-size-s, 12px));
}
...
.t-avatar--border-small {
  border-width: var(--td-avatar-border-width-small, 2px);
}
.t-avatar--border-medium {
  border-width: var(--td-avatar-border-width-medium, 3px);
}
.t-avatar--border-large {
  border-width: var(--td-avatar-border-width-large, 4px);
}
.t-avatar-group {
  display: -webkit-inline-box;
  display: -ms-inline-flexbox;
...
.t-swipe-cell__icon {
  font-size: var(--td-font-size-l, 20px);
}
...
.t-upload__delete-btn {
  ...
  width: 20px;
  height: 20px;
  color: var(--td-upload-delete-icon-color, var(--td-text-color-anti, var(--td-font-white-1, #ffffff)));
...
.t-result__title {
  ...
  font-size: var(--td-result-title-font-size, var(--td-font-size-l, 20px));
  font-weight: 700;
...
.t-table__filter-icon-wrap {
  ...
  -webkit-box-align: center;
      -ms-flex-align: center;
          align-items: center;
  pointer-events: all;
  height: var(--td-font-size-l, 20px);
  width: var(--td-font-size-l, 20px);
  margin-left: 8px;
}
