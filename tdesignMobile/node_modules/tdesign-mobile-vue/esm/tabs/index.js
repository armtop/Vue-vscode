...
import { defineComponent, createVNode, computed, ref, toRefs, Fragment, onMounted, onBeforeUnmount, onActivated, watch, nextTick, h, provide, readonly, mergeProps, inject, withDirectives, vShow } from 'vue';
import isFunction from 'lodash/isFunction';
import config from '../config.js';
import props$1 from './props.js';
...
var TTabNavItem = defineComponent({
  ...
  setup: function setup(props) {
    ...
    return function () {
      return createVNode("div", null, [renderTNodeContent("default", "label")]);
    };
  }
});
...
var name$1 = "".concat(prefix$1, "-tabs");
var LocalTabs = defineComponent({
  name: name$1,
  props: props$1,
  setup: function setup(props2) {
    ...
    var itemProps = computed(function () {
      ...
      children = res.filter(function (child) {
        return child.type.name === "".concat(prefix$1, "-tab-panel");
      });
    ...
    var moveToActiveTab = function moveToActiveTab() {
      if (navWrap.value && navLine.value && props2.showBottomLine) {
        ...
        var tabInner = tab.querySelector(".".concat(prefix$1, "-badge"));
        var style = {};
    ...
    return function () {
      ...
      }, [createVNode(_Sticky, mergeProps(stickyProps.value, {
...
var LocalTabPanel = defineComponent({
  name: name,
  props: props,
  setup: function setup(props2) {
    var renderTNodeContent = useContent();
...
var Tabs = withInstall(LocalTabs);
var TabPanel = withInstall(LocalTabPanel);
