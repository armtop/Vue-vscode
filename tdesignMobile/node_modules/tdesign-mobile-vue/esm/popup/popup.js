...
import { defineComponent, getCurrentInstance, ref, watch, nextTick, computed, h, resolveComponent, openBlock, createBlock, Teleport, createVNode, mergeProps, Transition, withCtx, withDirectives, createElementVNode, createElementBlock, normalizeClass, createCommentVNode, renderSlot, vShow } from 'vue';
...
var script = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var contentClasses = computed(function () {
      return _defineProperty({}, "".concat(name, "--").concat(props.placement), true);
    });
    ...
    var shouldLock = computed(function () {
      return wrapperVisible.value && props.preventScrollThrough;
    });
    watch(function () {
      return shouldLock.value;
    }, function (value) {
      value ? lock() : unlock();
    });
    return {
  ...
  return !_ctx.destroyOnClose || _ctx.wrapperVisible ? (openBlock(), createBlock(Teleport, {
    ...
    default: withCtx(function () {
      return [withDirectives(createElementVNode("div", mergeProps({
        class: [_ctx.name, _ctx.$attrs.class, _ctx.contentClasses],
        style: _ctx.rootStyles
      }, _ctx.$attrs), [_ctx.closeBtnNode ? (openBlock(), createElementBlock("div", {
        key: 0,
        class: normalizeClass("".concat(_ctx.name, "__close")),
