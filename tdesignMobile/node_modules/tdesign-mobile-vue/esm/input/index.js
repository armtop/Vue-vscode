...
import { defineComponent, ref, toRefs, computed, nextTick, watch, createVNode } from 'vue';
...
import { extendAPI, withInstall } from '../shared/component.js';
import './style';
import './type.js';
...
var Input = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    return function () {
      var readerPrefix = function readerPrefix() {
        var prefixIcon = readerTNodeJSX("prefixIcon");
        var label = readerTNodeJSX("label");
      ...
      var readerClearable = function readerClearable() {
      ...
      var readerSuffix = function readerSuffix() {
        var suffix = readerTNodeJSX("suffix");
        if (!suffix) {
          return null;
        }
        return createVNode("div", {
      ...
      var readerSuffixIcon = function readerSuffixIcon() {
        var suffixIcon = readerTNodeJSX("suffixIcon");
        if (!suffixIcon) {
          return null;
        }
        return createVNode("div", {
      ...
      var readerTips = function readerTips() {
        var tips = readerTNodeJSX("tips");
        if (!tips) {
          return null;
        }
        return createVNode("div", {
      ...
      }, null), readerClearable(), readerSuffix(), readerSuffixIcon()]), readerTips()])]);
    };
  }
});

var _Input = withInstall(Input);
