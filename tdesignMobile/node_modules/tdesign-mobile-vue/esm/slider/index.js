...
var Slider = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var classes = computed(function () {
      return ["".concat(sliderClass.value), _defineProperty(_defineProperty(_defineProperty({}, "".concat(sliderClass.value, "--top"), props2.label || state.scaleTextArray.length), "".concat(sliderClass.value, "--disabled"), disabled.value), "".concat(sliderClass.value, "--range"), props2.range)];
    });
    var sliderLineClasses = computed(function () {
      return ["".concat(sliderClass.value, "__bar"), "".concat(sliderClass.value, "__bar--").concat(props2.theme), _defineProperty(_defineProperty({}, "".concat(sliderClass.value, "__bar--disabled"), disabled.value), "".concat(sliderClass.value, "__bar--marks"), state.isScale && props2.theme === "capsule")];
    });
    ...
    var readerLineSingle = function readerLineSingle() {
      return createVNode("div", {
        "class": ["".concat(sliderClass.value, "__line"), "".concat(sliderClass.value, "__line--").concat(props2.theme), "".concat(sliderClass.value, "__line--single"), _defineProperty({}, "".concat(sliderClass.value, "__line--disabled"), disabled.value)],
    ...
    var readerLineRange = function readerLineRange() {
      return createVNode("div", {
        "class": ["".concat(sliderClass.value, "__line"), "".concat(sliderClass.value, "__line--").concat(props2.theme), _defineProperty({}, "".concat(sliderClass.value, "__line--disabled"), disabled.value)],
...
var _Slider = withInstall(Slider);
