...
var Skeleton = defineComponent({
  ...
  setup: function setup(props, _ref2) {
    ...
    var componentName = usePrefixClass("skeleton");
    var getColItemClass = function getColItemClass(obj) {
      return ["".concat(componentName.value, "__col"), "".concat(componentName.value, "--type-").concat(obj.type || "text"), _defineProperty({}, "".concat(componentName.value, "--animation-").concat(props.animation), props.animation)];
    };
...
var _Skeleton = withInstall(Skeleton);
