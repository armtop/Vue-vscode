...
import { defineComponent, inject, ref, computed, createVNode, mergeProps, provide, Fragment } from 'vue';
...
var _Avatar = defineComponent({
  ...
  setup: function setup(props) {
    ...
    var sizeReValue = ref(avatarGroupProps && avatarGroupProps.size || props.size);
    var sizeClass = "".concat(sizeReValue.value.indexOf("px") > -1 ? "medium" : sizeReValue.value);
    var avatarClasses = computed(function () {
      return ["".concat(avatarClass.value), "".concat(avatarClass.value, "--").concat(sizeClass), _defineProperty({}, "".concat(avatarClass.value, "--").concat(props.shape), props.shape), hasAvatarGroupProps ? "".concat(avatarClass.value, "--border ").concat(avatarClass.value, "--border-").concat(sizeClass) : ""];
    });
    ...
    return function () {
      ...
      var readerAvatar = function readerAvatar() {
        if (props.image && !props.hideOnLoadFailed) {
          return createVNode(_Image, mergeProps({
        ...
        return createVNode("span", null, [TNodeContent]);
      };
      return createVNode("div", {
      ...
      }, [createVNode(_Badge, props.badgeProps, {
  ...
  setup: function setup(props) {
    ...
    var readerAvatar = function readerAvatar() {
      ...
      if (isShowCollapse) {
        ...
        avatarList.push(createVNode(_Avatar, {
