...
import { defineComponent, ref, onMounted, computed, provide, toRefs, createVNode, isVNode, inject, watch, resolveComponent } from 'vue';
...
var LocalTabBar = defineComponent({
  name: name$1,
  props: TabBarProps,
  ...
  setup: function setup(props, context) {
    ...
    onMounted(function () {
      ...
      if (nodes !== void 0) {
        var childSlots = useChildSlots("".concat(prefix$1, "-tab-bar-item"));
    ...
    var tabBarClass = computed(function () {
      return ["".concat(name$1), _defineProperty(_defineProperty(_defineProperty({}, "".concat(name$1, "--bordered"), props.bordered), "".concat(name$1, "--fixed"), props.fixed), "".concat(name$1, "--safe"), props.safeAreaInsetBottom), "".concat(name$1, "--").concat(props.shape)];
    });
...
var LocalTabBarItem = defineComponent({
  name: name,
  components: {
    TBadge: _Badge,
  ...
  setup: function setup(props, context) {
    ...
    return function () {
      ...
      var textNodeContent = function textNodeContent() {
        return createVNode("div", {
          "ref": textNode,
          "class": _defineProperty(_defineProperty({}, "".concat(name, "__text"), true), "".concat(name, "__text--small"), !!iconContent())
      ...
      return createVNode("div", {
        "class": _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(name), true), "".concat(name, "--split"), split.value), "".concat(name, "--text-only"), !iconContent()), "".concat(name, "--crowded"), crowded.value), "".concat(name, "--").concat(shape.value), true), "".concat(context.attrs.class || ""), true)
      }, [createVNode("div", {
        "class": _defineProperty(_defineProperty(_defineProperty({}, "".concat(name, "__content"), true), "".concat(name, "__content--checked"), isChecked.value), "".concat(name, "__content--").concat(theme.value), true),
...
var TabBar = withInstall(LocalTabBar);
var TabBarItem = withInstall(LocalTabBarItem);
