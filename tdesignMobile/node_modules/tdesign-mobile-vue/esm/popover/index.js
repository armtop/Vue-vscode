...
import { isVNode, defineComponent, ref, computed, onUnmounted, watch, createVNode, Fragment, Transition } from 'vue';
  ...
  setup: function setup(props, context) {
    ...
    var placementPadding = function placementPadding(_ref) {
      ...
      if (isHorizontal) {
        ...
        return _defineProperty({}, isEnd ? "left" : "right", padding - 22);
      }
      var isVertical = vertical.find(function (item) {
        return placement.includes(item);
      });
      if (isVertical) {
        return _defineProperty({}, isEnd ? "top" : "bottom", popperHeight - 22);
      }
    };
