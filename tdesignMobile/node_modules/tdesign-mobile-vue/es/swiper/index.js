...
import { defineComponent, ref, toRefs, computed, watch, provide, onMounted, onUnmounted, createVNode, Fragment, inject, getCurrentInstance } from 'vue';
            ...
            if ("type" in navigation.value) {
              ...
              var fraction = function fraction() {
                ...
                if (((_navigation$value14 = navigation.value) === null || _navigation$value14 === void 0 ? void 0 : _navigation$value14.type) === "fraction") {
                  var _current$value3;
                  return createVNode("span", null, ["".concat(((_current$value3 = current.value) !== null && _current$value3 !== void 0 ? _current$value3 : 0) + 1, "/").concat(items.value.length)]);
                }
              };
              return createVNode("span", {
