...
declare const _default: import("vue").DefineComponent<{
    ...
    icon: {
        type: import("vue").PropType<boolean | "circle" | "line" | "rectangle" | (String | ((h: typeof h) => import("../common").SlotReturnValue))[]>;
        default: string;
    };
    ...
    name: string;
    block: boolean;
    icon: boolean | "circle" | "line" | "rectangle" | (String | ((h: typeof h) => import("../common").SlotReturnValue))[];
    disabled: boolean;
    modelValue: boolean;
