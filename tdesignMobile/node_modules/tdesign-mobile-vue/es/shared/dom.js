...
function getAttach(node) {
  if (!isBrowser) return;
  var attachNode = isFunction(node) ? node() : node;
...
export { addClass, elementInViewport, getAttach, getWindowScroll, getWindowSize, hasClass, preventDefault, removeClass, stopPropagation };
