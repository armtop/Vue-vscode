...
import { defineComponent, computed, createVNode, resolveComponent, mergeProps, ref, reactive, createApp, h, nextTick } from 'vue';
...
var Dialog = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var footerClass = computed(function () {
      return ["".concat(name, "__footer"), _defineProperty(_defineProperty({}, "".concat(name, "__footer--column"), props2.buttonLayout === "vertical"), "".concat(name, "__footer--full"), isTextStyleBtn.value && get(props2.actions, "length", 0) === 0)];
    });
    var buttonClass = computed(function () {
      return ["".concat(name, "__button"), _defineProperty(_defineProperty({}, "".concat(name, "__button--").concat(props2.buttonLayout), !isTextStyleBtn.value), "".concat(name, "__button--text"), isTextStyleBtn.value)];
    });
    ...
    return function () {
      ...
      return createVNode(resolveComponent("t-popup"), {
        ...
        default: function _default() {
          return [createVNode("div", {
            "class": "".concat(name, " ").concat(context.attrs.class || ""),
