...
import { defineComponent, ref, reactive, computed, watchEffect, watch, onMounted, onBeforeUnmount, provide, createVNode, getCurrentInstance, inject } from 'vue';
...
var LocalIndexes = defineComponent({
  name: name$1,
  props: IndexesProps,
  emits: ["select", "change"],
...
var LocalIndexesAnchor = defineComponent({
  name: name,
...
var Indexes = withInstall(LocalIndexes);
var IndexesAnchor = withInstall(LocalIndexesAnchor);

export { Indexes, IndexesAnchor };
