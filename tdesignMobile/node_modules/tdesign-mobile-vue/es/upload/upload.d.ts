...
declare const _default: import("vue").DefineComponent<{
    ...
    name: string;
    globalConfig: import("vue").ComputedRef<{} & import("../config-provider/type").UploadConfig>;
    ...
    addContent: import("vue").Ref<string | ((h: typeof import("vue").h) => import("../common").SlotReturnValue)>;
