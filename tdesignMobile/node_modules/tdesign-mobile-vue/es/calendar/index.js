...
import { defineComponent, inject, computed, ref, toRaw, watch, createVNode, Fragment, resolveComponent, mergeProps, provide, reactive, nextTick, onMounted } from 'vue';
...
var name$1 = "".concat(prefix$1, "-calendar");
var calendarTemplate = defineComponent({
  ...
  setup: function setup(_props, context) {
    ...
    var getDateItemClass = function getDateItemClass(dateItem) {
      var className = "".concat(name$1, "__dates-item");
      if (dateItem.type) {
        className = "".concat(className, " ").concat(name$1, "__dates-item--").concat(dateItem.type);
      }
    ...
    return function () {
      var renderCell = function renderCell(dateItem) {
        ...
        var className2 = "".concat(name$1, "__dates-item-suffix");
        if (dateItem.type) {
          className2 = "".concat(className2, " ").concat(name$1, "__dates-item-suffix--").concat(dateItem.type);
        }
        return createVNode(Fragment, null, [dateItem.prefix && createVNode("div", {
          "class": "".concat(name$1, "__dates-item-prefix")
        }, [dateItem.prefix]), dateItem.day, dateItem.suffix && createVNode("div", {
          "class": className2
        }, [dateItem.suffix])]);
      };
      var className = usePopup.value ? "".concat(name$1, " ").concat(name$1, "--popup") : "".concat(name$1);
      ...
      return createVNode("div", {
        ...
        "class": "".concat(name$1, "__close-btn"),
        "size": "24",
        "onClick": handleClose
      }, null), createVNode("div", {
        "class": "".concat(name$1, "__days")
      }, [(days.value || []).map(function (item, index) {
        return createVNode("div", {
          "key": index,
          "class": "".concat(name$1, "__days-item")
        }, [item]);
      })]), createVNode("div", {
        "class": "".concat(name$1, "__months"),
        "style": "overflow: auto"
      }, [months.value.map(function (item, index) {
        return createVNode(Fragment, null, [createVNode("div", {
          "class": "".concat(name$1, "__month"),
          "key": index
        }, [t(globalConfig.value.monthTitle, {
          year: item.year,
          month: globalConfig.value.months[item.month]
        })]), createVNode("div", {
          "class": "".concat(name$1, "__dates"),
          "key": index
...
var Calendar = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var selectedValueIntoView = function selectedValueIntoView() {
      ...
      var scrollContainer = templateRef.querySelector(".".concat(name, "__months"));
      var selectedDate = (_templateRef$querySel = templateRef.querySelector(".".concat(name, "__dates-item--").concat(type))) === null || _templateRef$querySel === void 0 || (_templateRef$querySel = _templateRef$querySel.parentNode) === null || _templateRef$querySel === void 0 ? void 0 : _templateRef$querySel.previousElementSibling;
      if (selectedDate) {
...
var _Calendar = withInstall(Calendar);
